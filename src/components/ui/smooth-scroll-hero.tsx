        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              Новая коллекция RUBEZH уже здесь. Премиальный стрит-вир для тех,
              <br className="hidden md:block" />
              кто выбирает качество, характер и стиль вне времени.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-2xl md:text-3xl font-black text-white mb-1">25 000+</div>
              ...
              <div className="text-center">
                ...
                <div className="text-2xl md:text-3xl font-black text-white mb-1">80+</div>
                <div className="text-xs md:text-sm text-gray-300 font-medium">Городов доставки</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Коллекции в год</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Премиум ткани</div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">RUBEZH ВЫБИРАЮТ ПО ВСЕМУ МИРУ</p>
              <div className="flex flex-wrap justify-center items-center gap-4 text-gray-300">
                <span className="text-xs font-semibold">ПРЕМИУМ ТКАНИ</span>
                <span className="text-xs font-semibold">РУЧНОЙ КОНТРОЛЬ</span>
                <span className="text-xs font-semibold">БЫСТРАЯ ДОСТАВКА</span>
                <span className="text-xs font-semibold">ОБМЕН И ВОЗВРАТ</span>
              </div>
            </div>
          </div>
        </motion.div>
